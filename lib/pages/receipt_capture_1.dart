...
class ReceiptCapture1 extends StatelessWidget {
  @override
                          ...
                          Positioned(
                            ...
                            child: SizedBox(
                              ...
                              child: SvgPicture.asset(
                                'assets/vectors/intersect_38_x2.svg',
                              ),
                            ),
                          ),
                    SizedBox(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: SizedBox(
                                                ...
                                                height: 14,
                                                child: SvgPicture.asset(
                                                  'assets/vectors/group_4446_x2.svg',
                                                ),
                                              ),
                                            ),
                                            Text(
                          ...
                          Positioned(
                            ...
                            child: ClipRRect(
                              ...
                              child: SizedBox(
                                ...
                                height: 195.4,
                                child: SvgPicture.asset(
                                  'assets/vectors/rectangle_40241_x2.svg',
                                ),
                              ),
                            ),
                          ),
                    Container(
                              padding: EdgeInsets.fromLTRB(10.7, 12, 0, 9.4),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0.3, 0, 11, 23),
                                    child: Stack(
                                      children: [
                                        SizedBox(
                                          width: double.infinity,
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    height: 164,
                                                    child: SvgPicture.asset(
                                                      'assets/vectors/rectangle_40212_x2.svg',
                                                    ),
                                                  ),
                                                ),
                                              ),
                                              ClipRRect(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  height: 164,
                                                  child: SvgPicture.asset(
                                                    'assets/vectors/rectangle_40222_x2.svg',
                                                  ),
                                                ),
                                              ),
                                            ],
                                        ...
                                        Positioned(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                  margin: EdgeInsets.fromLTRB(0, 0, 18, 0.1),
                                                  child: SizedBox(
                                                    width: 25,
                                                    height: 25,
                                                    child: SvgPicture.asset(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 107.2, 0, 0),
                                        child: ClipRRect(
                                          borderRadius: BorderRadius.circular(5),
                                          child: SizedBox(
                                            width: 46.9,
                                            height: 195.4,
                                            child: SvgPicture.asset(
                                              'assets/vectors/rectangle_40252_x2.svg',
                                            ),
                                          ),
                                        ),
                                      ),
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 0, 0, 182.6),
                                        child: Text(
                                          'Receipt edge',
                                          style: GoogleFonts.getFont(
                                            'Open Sans',
