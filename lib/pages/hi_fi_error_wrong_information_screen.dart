...
class HiFiErrorWrongInformationScreen extends StatelessWidget {
  @override
                        ...
                        Positioned(
                          ...
                          child: SizedBox(
                            ...
                            child: SvgPicture.asset(
                              'assets/vectors/intersect_31_x2.svg',
                            ),
                          ),
                        ),
                  SizedBox(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  height: 14,
                                                  child: SvgPicture.asset(
                                                    'assets/vectors/group_4427_x2.svg',
                                                  ),
                                                ),
                                              ),
                                              Text(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: SizedBox(
                                          ...
                                          height: 20,
                                          child: SvgPicture.asset(
                                            'assets/vectors/union_94_x2.svg',
                                          ),
                                        ),
                                      ),
                                    ],
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Container(
                            ...
                            child: Container(
                              width: 110,
                              height: 110,
                              padding: EdgeInsets.fromLTRB(0, 33, 0, 33),
                              child: SizedBox(
                                width: 44,
                                height: 44,
                                child: SvgPicture.asset(
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(4.4, 0, 4.4, 57),
                          child: RichText(
                            ...
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text: ' information you provided is incorrect',
                                  style: GoogleFonts.getFont(
                                    'Open Sans',
                                    fontWeight: FontWeight.w600,
                                    fontSize: 20,
                                ...
                                TextSpan(
                                  text: 'Please review your input and try again.',
                                  style: GoogleFonts.getFont(
                                    'Open Sans',
                                    fontWeight: FontWeight.w400,
                                    fontSize: 20,
                          ...
                          children: [
                            Container(
                              ...
                              child: Container(
                                ...
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(0, 10, 0.6, 10),
                                  child: Text(
                                    'Try Again',
                                    style: GoogleFonts.getFont(
                                      'Open Sans',
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 0, 0, 15),
                              padding: EdgeInsets.fromLTRB(0, 8.8, 0.5, 8.8),
                              decoration: BoxDecoration(
                                border: Border.all(color: Color(0xFF831441)),
                                borderRadius: BorderRadius.circular(34),
                              ),
